...
// Texts array ko component se baahar move kiya taake useEffect dependency ka error na aaye
const texts = [
  "Frontend Developer",
      ...
      <section className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-24 pt-36 gap-16">
        ...
        <div className="max-w-2xl text-center md:text-left">
          ...
          <p className="text-gray-400 text-lg md:text-2xl leading-9 mb-10">
            I create modern, responsive and visually engaging web applications
            using React.js, JavaScript and CSS.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl p-10 shadow-xl hover:-translate-y-2 transition duration-300">
            ...
            <p className="text-gray-300 text-lg leading-9">
              I love building modern, responsive and interactive websites with
              clean UI and smooth user experience.
              <br />
              <br />
              My focus is creating visually engaging interfaces using React.js and
          ...
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl p-10 shadow-xl hover:-translate-y-2 transition duration-300">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-3xl font-bold">Education & Goals</h3>
            </div>
            <p className="text-gray-300 text-lg leading-9">
              Currently pursuing BS Software Engineering at IIUI (International
              Islamic University Islamabad) Batch 2024-2028.
              <br />
              <br />
      ...
      <section id="projects" className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl overflow-hidden hover:scale-105 transition duration-300 shadow-xl">
            ...
            />
            <div className="p-8">
              <h3 className="text-3xl font-bold mb-5">Image Gallery</h3>
          ...
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl overflow-hidden hover:scale-105 transition duration-300 shadow-xl">
            ...
            />
            <div className="p-8">
              <h3 className="text-3xl font-bold mb-5">Calculator App</h3>
              <p className="text-gray-400 leading-8 mb-6">
          ...
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl overflow-hidden hover:scale-105 transition duration-300 shadow-xl">
            ...
            />
            <div className="p-8">
              <h3 className="text-3xl font-bold mb-5">Hijri Countdown</h3>
              <p className="text-gray-400 leading-8 mb-6">
          ...
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl overflow-hidden hover:scale-105 transition duration-300 shadow-xl">
            ...
            />
            <div className="p-8">
              <h3 className="text-3xl font-bold mb-5">Personal Portfolio</h3>
              <p className="text-gray-400 leading-8 mb-6">
      ...
      <section id="contact" className="px-6 py-24">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="bg-[#111] border border-orange-500/20 rounded-2xl p-8 text-center hover:-translate-y-2 transition duration-300">
            ...
            <p className="text-gray-400">zubairzk2244@gmail.com</p>
          </div>

          <div className="bg-[#111] border border-orange-500/20 rounded-2xl p-8 text-center hover:-translate-y-2 transition duration-300">
            <h3 className="text-2xl font-bold mb-4">Phone</h3>
            <p className="text-gray-400">+92 3207921826</p>
          </div>
